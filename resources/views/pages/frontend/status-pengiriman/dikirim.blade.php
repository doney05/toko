            ...
            <div class="card card-menu">
                <div class="card-body">
                    <div class="row menu-link" style="text-align: center">
                        ...
                        <div class="col-2" style="    border-right: 3px solid #fff;">
                            <a href="{{ url('status/dikirim/'. Auth::user()->id)}}" class="active">Dikirim</a>
                        </div>
                        <div class="col-2" style="    border-right: 3px solid #fff;">
                        ...
                        <div class="card-body result">
                            <div class="row">
                                ...
                                <div class="col-3" style="text-align: center">
                                    ...
                                    <p style="font-size: 18px; font-style: italic; color:green">Paket Dikirim...</p>
                                </div>
                            </div>
                        </div>
                    </div>
