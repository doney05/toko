                    ...
                    <div class="card-body">
                        <div class="row menu-link" style="text-align: center">
                            ...
                            <div class="col-3 batal">
                                <a href="{{ url('status/batal/'. Auth::user()->id)}}" class="active">Batal</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body result">
                                <div class="row">
                                    <div class="col-9">
                                        ...
                                        @endif --}}
                                        <div class="detail">
                                            <a href="{{ url('status/detail-beli/'. $item->id) }}" class="mt-3" style="color: purple">Detail Pembelian</a>
                                    </div>
                                    </div>
                                    <div class="col-3" style="text-align: center">
                                        <h5 class="mb-3">Total Produk : {{ count( $item['paymentdetail']) }}</h5>
                                        <p class="konfirm" style="font-size: 18px; color:red">Pembayaran Tidak Sesuai...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
