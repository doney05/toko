                    ...
                    <div class="card-body">
                        <div class="row menu-link" style="text-align: center">
                            ...
                            <div class="col-2 dikemas" style="    border-right: 3px solid #fff;">
                                <a href="{{ url('status/dikemas/'. Auth::user()->id)}}"  class="active">Dikemas</a>
                            </div>
                        ...
                        <div class="card " style=" margin-top: 10px;">
                            <div class="card-body result">
                                <div class="row">
                                    ...
                                    <div class="col-4 col-sm-4 col-md-3 col-lg-3" style="text-align: center">
                                        <h5 class="mb-3">Total Produk : {{ count($item['paymentdetail']) }}</h5>
                                        <p class="konfirm" style="color:green">Paket Dikemas...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
